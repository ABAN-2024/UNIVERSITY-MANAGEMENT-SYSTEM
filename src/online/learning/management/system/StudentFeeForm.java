...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/icons/fee.jpg"));
        ...
        String course[] = {"BTech","BCom(Hons)","BCA","Bsc","BA", "Msc","MBA","MCA","MCom","MTech"};
        ...
        String branch[] = {"Computer Science","Electronics","Mechanical Eng.","Civil Eng.","IT"};
